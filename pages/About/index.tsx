    ...
    <div className="flex justify-center items-center  bg-gray-100 ">
      <div className="mx-auto  px-6 lg:px-[12rem] 2xl:px-[17rem] pt-20 lg:pt-28 pb-16 mt-10 ">
        ...
        <p className="mb-4 text-xl">
          ...
          people, Jennifer has mastered the art of balancing authority with
          approachability, creating a space where businesses feel both supported
          and inspired to reach new heights. With a background in ethnographic
          research, her consultancy is built on the belief that every
          organization has a unique story to tell, and she takes a creative,
          authentic, and values-based approach to help bring those stories to
          life. Though she works for a large Corporation, her passion is small
          woman-owned businesses in the South Bay of Los Angeles.
        </p>
        <Image
          ...
          <div className="flex flex-col mx-auto md:flex-row text-xl lg:justify-between  mt-9 gap-16">
            ...
            <div>
              <p className="mb-4">
                ...
                strategies are designed to foster resilience, authenticity, and
                sustainable success.
              </p>
              <br />
              <p>
                ...
                sharing. Through her consultancy, she empowers organizations to
                not only grow but also to shine as their most authentic selves.
              </p>
            </div>
          </div>
        </motion.div>
