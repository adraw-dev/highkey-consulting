            ...
            <div className="bg-lightgrey py-20" id="blog-section">
                <div className='mx-auto max-w-7xl sm:py-4 lg:px-8 '>
                    ...
                    <div className="text-center">
                        <h3 className="text-aqua text-lg font-normal tracking-widest">ARTICLES</h3>
                        ...
                        {postData.map((items, i) => (
                            <div key={i} >
                                ...
                                <div className='bg-white m-3 px-3 pt-3 pb-12 my-10 shadow-lg rounded-3xl relative'>
                                    ...
                                    <Link href="/">
                                        <h3 className="absolute bg-aqua text-white hover:bg-charoal hover:shadow-xl py-3 px-6 rounded-full article-img">{items.time} read</h3>
                                    </Link>
