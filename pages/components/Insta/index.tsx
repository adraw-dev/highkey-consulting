    ...
    <div className="mx-auto max-w-2xl  pb-16 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
      <div className=" mt-24 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
        ...
        <div className="mx-auto imageContainer">
          ...
          <Link
            href={
              "https://www.linkedin.com/posts/jenniferleighvelez_dei-equity-inclusion-activity-7299111558788395008-hqPx?utm_source=share&utm_medium=member_desktop&rcm=ACoAACSM8FYBcXZmiL-p3pY1E0RDf5o79pH_eAA"
            }
            target="_blank"
          >
            <button
