    ...
    <div className="bg-gray-100 min-h-screen ">
      <div className="mx-auto  px-6  lg:px-[5rem] xl:px-[12rem] pt-20 lg:pt-28  pb-16 mt-10  ">
        ...
        <p className="text-xl mb-12 text-center ">
          ...
          individual consulting sessions on very specific issues. Please reach
          out to us with your inquiry, and we can put together a plan to suit
          your needs. We love an individualized approach.
        </p>
