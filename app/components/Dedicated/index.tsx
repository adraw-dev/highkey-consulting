        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 my-16">
          ...
          <div className="relative text-white">
            <h2 className="text-4xl lg:text-65xl pt-4 font-bold sm:leading-tight mt-5 text-center lg:text-start">
              Be transparent about who you are, what your brand is, its values,
              and practices.{" "}
            </h2>
            <p className="font-medium text-white text-2xl mt-5 text-center lg:text-start">
              ...
              and share behind the scenes content. Allow people to connect with
              you so they feel like they can connect to your mission.
            </p>
